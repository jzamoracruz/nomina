<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="nomina"){ ?>    
        <?php 
            if(isset($_POST['id_del'])){
             ...
             if($_SESSION['nombre']!="" && $_SESSION['tipo']=="nomina"){   
          
                    if(isset($_POST['id_edit'])){
                        $id_user=MysqlQuery::RequestPost('id_edit');
                        if(MysqlQuery::Editar("cliente", "id_cliente='$id_user'")){
                            echo '
                                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    <h4 class="text-center">USUARIO ELIMINADO</h4>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, en esta página se muestran todos los usuarios y administradores registrados en Sistema de nomina, usted podra eliminarlos si lo desea.</p>
            </div>
          </div>
        </div>
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Desprendible</th>
                                        <th class="tetx-center">C Labora</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo number_format($row['salario']); ?></td>
                                        <td class="text-center">
                                            <form action="" method="POST" style="display: inline-block;">
                                                <button id="saved" class="btn btn-success" data-id="<?php echo $row['id_cliente']; ?>"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp; Generar desprendible</button>
                                            </form>
                                        </td>

                                        <td class="text-center">
                                            <form action="" method="POST" style="display: inline-block;">
                                                <button id="save" class="btn btn-success" data-id="<?php echo $row['id_cliente']; ?>"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp; Generar C Laboral</button>
                                            </form>
                                        </td>
                                        <td class="text-center">
                                            <form action="" method="POST" style="display: inline-block;">
                                        ...
                                        <td class="text-center">
                                            <form action="" method="POST" style="display: inline-block;">
                                                <input type="hidden" name="id_edit" value="<?php echo $row['id_cliente']; ?>">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 animated flip">
                    <h1 class="text-danger">Lo sentimos esta página es solamente para administradores de Sistema de nomina</h1>
