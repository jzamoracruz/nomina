...
<nav class="navbar navcolor navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <!-- <a class="navbar-brand" href="index.php"><i class="fa fa-users"></i>&nbsp;&nbsp;tickets</a> -->
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if($_SESSION['tipo']=="nomina"): ?>
                            <li>
                            <a href="nomina.php?view=config"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Configuracion</a>
                        </li> 

                        <li>
                            <a href="nomina.php?view=users"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Ver Usuarios</a>
                        </li> 
                        ...
                        <li>
                            <a href="admin.php?view=ticketadmin"><span class="glyphicon glyphicon-envelope"></span> &nbsp; Administrar novedades</a>
                        </li>
                        <li>
            ...
            <ul class=" nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="./index.php?view=soporte"><span class="glyphicon glyphicon-flag"></span>&nbsp;&nbsp;Registrar novedad</a>
                </li>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
          ...
          <form action="" method="POST" style="margin: 20px;">
             ...
             <div class="radio">
                <label>
                    <input type="radio" name="optionsRadios" value="nomina">
                     Empleado
                </label>
             </div>
