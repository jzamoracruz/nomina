  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        Provincia: Angaraes <br>
        Distrito: <br>
        Telefono: +51 921223114 <br>
        E-mail: <a href="#">laparichar.1997@gamil.com</a>
        </p>
      </div>
      <div class="col-sm-4">
    ...
    <h4 class="text-center" style="color: #FFF;">Codemaster CopyRight © 2020</h4>
  </div>
</footer> -->