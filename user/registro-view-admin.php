<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $asunto="Registro de cuenta en Sistema de nomina";
        $cabecera="From: Sistema de nomina El Salvador<Sistema de nomina@hifenix.com>";
        $mensaje_mail="Hola ".$nombre_reg.", Gracias por registrarte en Sistema de nomina El Salvador. Los datos de cuenta son los siguientes:\nNombre Completo: ".$nombre_reg."\nNombre de usuario: ".$user_reg."\nClave: ".$clave_reg2."\nEmail: ".$email_reg."\n Página principal: http://www.Sistema de nomina.com/index.php";

        
        if(MysqlQuery::Guardar("administrador", "nombre_completo, nombre_admin, clave, amial_admin", "'$nombre_reg', '$admin_reg', '$email_reg', '$clave_reg'")){
            ...
            echo '
                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        Cuenta creada exitosamente, ahora puedes iniciar sesión, ya eres usuario de Sistema de nomina.
                    </p>
                </div>
            ';
        }else{
